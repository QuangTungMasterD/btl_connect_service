...
class HandleAlert:
    ...
    async def _log_channel(self, event_id: str, user_id: str, channel: str, status: str, message: str = None, error: str = None):
        try:
    ...
    async def _log_low_severity(self, event_id: str, user, title: str, message: str):
